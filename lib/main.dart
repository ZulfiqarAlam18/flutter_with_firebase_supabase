...
import 'package:flutter_firebase/views/student_screens/delete.dart' show DeleteStudentScreen;
    ...
    return ScreenUtilInit(
      ...
      builder: (context, child) => GetMaterialApp(
        ...
        getPages: [
          ...
          GetPage(name: '/update-student', page: () => UpdateStudentScreen()),
          GetPage(name: '/delete-student', page: () => DeleteStudentScreen()),
        ],
      ),
    );
  }
